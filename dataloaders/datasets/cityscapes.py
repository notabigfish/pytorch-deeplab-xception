...
class CityscapesSegmentationZS(data.Dataset):
    ...
    def __init__(self, args, root=Path.db_root_dir('A'), split="train"):
        ...
        self.class_names = ['sky', 'tree', 'grass', 'background']
    ...
    def __getitem__(self, index):
        ...
        img_path = lbl_path.replace('labels', 'images')
...
if __name__ == '__main__':
    ...
    cityscapes_train = CityscapesSegmentationZS(args, split='train')
